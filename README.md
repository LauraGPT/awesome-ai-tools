...
- [FunASR](https://www.funasr.com) - Open-source industrial speech recognition toolkit. 50+ languages, 170x realtime, speaker diarization, emotion detection. Self-hosted with OpenAI-compatible API. ([Source Code](https://github.com/modelscope/FunASR))
